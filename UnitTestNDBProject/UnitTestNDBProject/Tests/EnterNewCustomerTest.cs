...
namespace UnitTestNDBProject.Tests
{
    ...
    class EnterNewCustomerTest : BaseTestClass
    {
        ...
        public void A3_VerifyCustomerCreation()
        {
            ...
            EnterNewCustomerPage_.ClickEnterNewCustomerButton().EnterFirstName(sheetData.FistNameUnique()).EnterLastName(sheetData.LastNameUnique()).EnterPhoneNumber(sheetData.phoneNumber1).SelectPhoneType(sheetData.phoneType1).AddEmailAddress(sheetData.EmailAddressUnique());
        ...
        public void A4_VerifyCustomerPageTurnViewOnly()
        {
            ...
            Assert.True(EnterNewCustomerPage_.VerifCustomerIsCreatedWithValidFirstName(sheetData.FistNameUnique()));
            Assert.True(EnterNewCustomerPage_.VerifCustomerIsCreatedWithValidLastName(sheetData.LastNameUnique()));
        }
